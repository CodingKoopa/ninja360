...
xboxdrv --evdev "$PORT_2_EVDEV_PATH" --config $MAIN_CONFIG --alt-config $CONTROLLER_CONFIG &
...
echo "RocketCube started successfully! Note that it might take some time for the new mapping to take
